...
class Api::V1::ReservationsController < ApiController
    ...
    def create
      ...
      @new_reservation = @user.reservations.create(city: params[:city], date: params[:date], doctor_id: params[:doctor_id])
    ...
    def destroy
      ...
      if @reservation.destroy
        render json: { success: true, message: 'Reservation deleted', data: { reservation: @reservation } }, status: :created
      else
